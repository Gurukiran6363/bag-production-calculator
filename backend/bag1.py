...
total_handles_needed = inputs["num_bags"] * inputs["handles_per_bag"]

box_w = (2 * inputs["bag_width"]) + inputs["side_allowance"]
box_h = inputs["bag_height"] + inputs["bottom_allowance"] + inputs["top_allowance"]
box_result = evaluate_style("Box Cutting", box_w, box_h, inputs, total_handles_needed)
...
return jsonify({
    ...
    "recommendation": {
        ...
        "average_cost_per_bag": best_style["total_cost"] / inputs["num_bags"] if inputs["num_bags"] > 0 else 0
    }
})
